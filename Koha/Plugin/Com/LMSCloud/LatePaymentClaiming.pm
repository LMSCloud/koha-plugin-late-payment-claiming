...
sub install {
    ...
    C4::Context->dbh->do(
                q{
                    ...
                    ('members','LATE_PAYMENT_CLAIM','','Mahnung offener Gebühren (Plugin)',1,'[% claim.level %]. Gebührenmahnung','[% USE KohaDates %]\r\n[% USE Price %]\r\n[% USE date %]\r\n[% calc = date.calc %]\r\n[% MACRO today_plus_days(days) BLOCK %][% td = calc.Today() %][% result = calc.Add_Delta_Days(td.0,td.1,td.2, days) %][% result.2 | format(\'%02d\') %].[% result.1 | format(\'%02d\') %].[% result.0 | format(\'%02d\') %][% END %]\r\n\r\n\r\n<!DOCTYPE html>\r\n<html>\r\n<head>\r\n	<title>[% claim.level %]. Gebührenmahnung</title>\r\n</head>\r\n<body dir=\"auto\" style=\"word-wrap: break-word; -webkit-nbsp-mode: space; line-break: after-white-space; font-family: Arial, sans-serif;\">\r\n<h2>[% branch.branchname | html %]</h2>\r\n<p>Telefon: [% branch.branchphone %]<br />\r\n    E-Mail: [% branch.branchreplyto %]</p>\r\n<br />\r\n    [% borrower.firstname | html %] [% borrower.surname | html %]<br />\r\n    Ausweis-Nummer: [% borrower.cardnumber | html %]<br />\r\n    Ausweis gültig bis: [% borrower.dateexpiry | $KohaDates %]\r\n    <br /><br />\r\n    [% today_plus_days(0) %]\r\n    <br /><br /><br />\r\n\r\n[% IF borrower.title == \"Herr\" %]\r\nSehr geehrter Herr [% borrower.surname | html %],\r\n[% ELSIF borrower.title == \"Herr Dr.\" %]\r\nSehr geehrter Herr Dr. [% borrower.surname | html %],\r\n[% ELSIF borrower.title == \"Frau Dr.\" %]\r\nSehr geehrter Herr Dr. [% borrower.surname | html %],\r\n[% ELSIF borrower.title == \"Frau\" %]\r\nSehr geehrte Frau [% borrower.surname | html %],\r\n[% ELSE %]\r\nGuten Tag [% borrower.title | html %] [% borrower.surname | html %],\r\n[% END %] <br /><br />\r\n\r\nwir möchten Sie darauf aufmerksam machen, dass für die oben genannte Ausweisnummer bei uns noch Gebühren in Höhe von <strong>[% borrower.get_account_balance | $Price %] Euro</strong> offen sind.<br /><br />\r\n\r\nFalls Sie Fragen bezüglich des Zustandekommens oder der Höhe dieser Gebühren haben, helfen wir Ihnen gerne persönlich, telefonisch oder per E-Mail (<a href=\"mailto:[% branch.branchemail | html %]\">[% branch.branchemail | html %]</a>) weiter.<br /><br />\r\n\r\nUm weitere kostenpflichtige Gebührenmahnungen zu vermeiden, bitten wir Sie, den ausstehenden Betrag <strong>bis zum [% today_plus_days(10) %]</strong> zu begleichen.<br /><br /><br />\r\n\r\nMit freundlichen Grüßen<br /><br />\r\nIhre [% branch.branchname | html %]\r\n\r\n<br /><br />\r\n[% branch.opac_info.content %]\r\n</body>\r\n</html>','email','default','2026-05-13 11:27:09'),
                    ('members','LATE_PAYMENT_CLAIM','','Mahnung offener Gebühren (Plugin)',1,'[% claim.level %]. Gebührenmahnung','[% USE Price %]\r\n[% USE date %]\r\n[% calc = date.calc %]\r\n[% MACRO today_plus_days(days) BLOCK %][% td = calc.Today() %][% result = calc.Add_Delta_Days(td.0,td.1,td.2, days) %][% result.2 | format(\'%02d\') %].[% result.1 | format(\'%02d\') %].[% result.0 | format(\'%02d\') %][% END %]\r\n\r\n<div class=\"page-header\">\r\n    <!-- Hier evtl. Header(bild) einfügen (erscheint auf jeder Seite) -->\r\n    </div>\r\n    <div class=\"falzmarke\"></div>\r\n    \r\n    <table class=\"message\">\r\n    \r\n    <thead>\r\n      <tr>\r\n        <td>\r\n          <!--place holder for the fixed-position header-->\r\n          <div class=\"page-header-space\"></div>\r\n        </td>\r\n      </tr>\r\n    </thead>\r\n    \r\n    <tbody>\r\n        <tr>\r\n            <td colspan=\"2\" style=\"text-align:center;\">\r\n                <img src=\"https://sb-xy.lmscloud.net/webcustom/images/custom/Logo.png\" style=\"width:180px; float:right;margin-right: 10px;\"></img>\r\n            </td>\r\n        </tr>\r\n        <tr>\r\n            <td class=\"addresses\">\r\n                <div class=\"return_address\">[% branch.branchname | html %] · [% branch.branchaddress1 | html %] · [% branch.branchzip %] [% branch.branchcity | html %]</div>\r\n                <div class=\"address\">\r\n                    <br />[% borrower.title | html %]<br />\r\n                    [% borrower.firstname | html %] [% borrower.surname | html %]<br />\r\n                    [% borrower.address | html %] [% borrower.streetnumber | html %] [% borrower.address2 | html %]<br />\r\n                    [% borrower.zipcode | html %] [% borrower.city | html %]\r\n                </div>\r\n            </td>\r\n            <td class=\"library_info\">\r\n               [% branch.branchaddress1 | html %]<br />\r\n               [% branch.branchzip | html %] [% branch.branchcity | html %]<br />\r\n               Fax: [% branch.branchfax | html %]<br />\r\n               [% branch.branchreplyto | html %]<br />\r\n               \r\n                <p style=\"font-size: 11pt; margin: 0;\">Datum: [% today_plus_days(0) %]</p>\r\n            </td>\r\n        </tr>\r\n          \r\n        <tr>\r\n            <td colspan=\"2\">\r\n                <table style=\"width:100%\">\r\n                <tbody>\r\n                    <tr>\r\n                        <td class=\"topic\">Betreff</td>\r\n                        <td class=\"cardnumber\">Ausweis-Nr.</td>\r\n                        <td class=\"manager\"></td>\r\n                        <td class=\"date\">Datum</td>\r\n                    </tr>\r\n                    <tr>\r\n                        <td class=\"topictext\">[% claim.level | html %]. Gebührenmahnung</td>\r\n                        <td class=\"cardnumbertext\">[% borrower.cardnumber | html %]</td>\r\n                        <td class=\"managertext\"></td>\r\n                        <td class=\"datetext\">[% today_plus_days(0) %]</td>\r\n                    </tr>\r\n                </tbody>\r\n                </table>\r\n            </td>\r\n        </tr> \r\n          \r\n        <tr>\r\n            <td colspan=\"2\" class=\"content\">\r\n                <p>[% IF borrower.title == \"Herr\" %]\r\nSehr geehrter Herr [% borrower.surname | html %],\r\n[% ELSIF borrower.title == \"Herr Dr.\" %]\r\nSehr geehrter Herr Dr. [% borrower.surname | html %],\r\n[% ELSIF borrower.title == \"Frau Dr.\" %]\r\nSehr geehrter Herr Dr. [% borrower.surname | html %],\r\n[% ELSIF borrower.title == \"Frau\" %]\r\nSehr geehrte Frau [% borrower.surname | html %],\r\n[% ELSE %]\r\nGuten Tag [% borrower.title | html %] [% borrower.surname | html %],\r\n[% END %]</p>\r\n                <p>wir möchten Sie darauf aufmerksam machen, dass für die oben genannte Ausweisnummer bei uns noch Gebühren in Höhe von <strong>[% borrower.get_account_balance | $Price %] Euro</strong> offen sind.<br /><br />\r\nFalls Sie Fragen bezüglich des Zustandekommens oder der Höhe dieser Gebühren haben, helfen wir Ihnen gerne persönlich, telefonisch oder per E-Mail ([% branch.branchemail | html %]) weiter.<br /><br />\r\nUm weitere kostenpflichtige Gebührenmahnungen zu vermeiden, bitten wir Sie, den ausstehenden Betrag <strong>bis zum [% today_plus_days(10) %]</strong> zu begleichen.</p>\r\n    \r\n                <br />\r\n               Mit freundlichen Grüßen<br /><br />\r\n               Ihre [% branch.branchname | html %]\r\n            </td>\r\n        </tr>\r\n    </tbody>\r\n    \r\n    <tfoot>\r\n        <tr>\r\n            <td>\r\n                <!--place holder for the fixed-position footer-->\r\n                <div class=\"page-footer-space\"></div>\r\n            </td>\r\n        </tr>\r\n    </tfoot>\r\n    \r\n    </table>\r\n    \r\n    <div class=\"page-footer\">\r\n    </div>','print','default','2026-05-13 11:27:09');
                }
            );
